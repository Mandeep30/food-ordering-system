package com.neonex.domain.outbox.scheduler.approval;

import com.neonex.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import com.neonex.domain.port.output.message.publisher.restaurant.RestaurantApprovalRequestMessagePublisher;
